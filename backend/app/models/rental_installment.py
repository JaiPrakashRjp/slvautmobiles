"""A rent-collection reminder row (a due amount + date) on a rental."""
...
class RentalInstallment(Base):
    __tablename__ = "rental_installments"
    __table_args__ = (
        UniqueConstraint("rental_id", "number", name="rental_installments_unique"),
    )
    ...
    rental: Mapped["Rental"] = relationship(back_populates="installments")  # noqa: F821
