...
Run by cron at 4:45 PM IST (= 11:15 UTC on the server):

    15 11 * * * cd /opt/slv-dev/backend && /opt/slv-dev/venv/bin/python -m app.jobs.run_reminders >> /var/log/slv-reminders.log 2>&1
