...
/// Loan business report over a month / custom range — loans booked, EMI
/// collected, EMIs due, and the current outstanding balance. Mirrors the rental
/// report: EMIs replace rent reminders, principal replaces total, collected
/// keys off each EMI's received/paid date.
class LoanMonthlyReportScreen extends StatefulWidget {
  const LoanMonthlyReportScreen({super.key});

  @override
  State<LoanMonthlyReportScreen> createState() =>
      _LoanMonthlyReportScreenState();
}

class _LoanMonthlyReportScreenState extends State<LoanMonthlyReportScreen> {
  int _mode = 0;
                    ...
                    Row(children: [
                      Expanded(
                        child: SecondaryButton(
                          ...
                          onPressed: () => context
                              .read<PdfService>()
                              .previewLoanBusinessReport(report),
                        ),
                      ),
                      ...
                      Expanded(
                        child: PrimaryButton(
                          ...
                          onPressed: () => context
                              .read<PdfService>()
                              .shareLoanBusinessReport(report),
                        ),
                      ),
                    ]),
                  ],
  ...
  Widget _overview(AppColors c, LoanReport r) {
